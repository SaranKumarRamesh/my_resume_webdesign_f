...
const yOff = 0.0015;
const zOff = 0.0015;
const backgroundColor = 'hsla(0, 0%, 0%, 1)'; // Black color
...
function drawRay(x, y1, y2, life, ttl, width, hue) {
  ...
  gradient.addColorStop(0, `hsla(0, 0%, 50%, 0)`); // Start with a grey color
  gradient.addColorStop(0.5, `hsla(0, 0%, 50%, ${fadeInOut(life, ttl)})`); // Middle color
